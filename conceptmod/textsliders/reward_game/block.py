...
def main():
    ...
    q=sub.add_parser('evaluate');q.add_argument('--checkpoint',required=True);q.add_argument('--multiplier',type=float,default=1.);q.add_argument('--stage',default='auto',choices=('auto','4','8','16'));q.add_argument('--tag',default='block-manual');q.add_argument('--max-new-clips',type=int,default=16)
    ...
    if a.action=='init':
        ...
        from . import block_evaluate as e
