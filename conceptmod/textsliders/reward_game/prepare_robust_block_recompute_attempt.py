...
def prepare(home):
    ...
    collection = home/'training/acoustic-block-parent-v2'; folder = home/'training/acoustic-block-robust-recompute-v1'
    ...
    for name in ('train_robust_block_recompute.py', 'recomputed_flow_forward.py', 'prepare_robust_block_recompute_attempt.py', 'robust_block_controller.py',
    ...
    test = package.parents[2]/'tests/test_reward_game_robust_block_recompute.py'
    ...
    training = dict(method='joint-regression-sensitive-full-batch-block-recompute-v1', parent=parent, structure=STRUCTURE,
        ...
        graph_storage='Whole transformer call reentrant recomputation with inner block checkpointing',
        execution_amendment_sha256=sha(home/'amendments/robust-block-recomputation-v1/amendment.json'),
    ...
    recipe['argv'] = [recipe['argv'][0], '-u', '-m', 'conceptmod.textsliders.reward_game.train_robust_block_recompute',
    ...
    path = home/'recipes/robust-block-recompute-2.json'; immutable(path, recipe)
