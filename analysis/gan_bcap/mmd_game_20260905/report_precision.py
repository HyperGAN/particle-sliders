...
def main():
    ...
    parser.add_argument('--round', default='round-0002')
    ...
    outcome = ('The candidate improved the MMD personal best.' if candidate['score'] > previous['mmd']
               else 'The candidate lost the audio challenge despite its lower training loss.')
    ...
    page = f'''<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>MMD round 2: float32 training</title>
...
<h1>MMD round 2: float32 training</h1><p>Locked audio comparison: two prompts × two seeds, 20 seconds each. Higher scores are better. This judge is a heuristic; listen to the individual clips.</p>
