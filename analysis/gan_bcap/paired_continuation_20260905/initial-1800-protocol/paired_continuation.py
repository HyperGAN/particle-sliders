...
STEPS = (750, 900, 1050, 1200, 1350, 1500, 1650, 1800)
SEEDS = (7, 23, 101, 303)
...
def setup():
    ...
    protocol = dict(version=1, arms=list(ARMS), checkpoints=list(STEPS), gpu=0,
        ...
        rule=RULE, worthwhile_gain=.05, family_alpha=.05, planned_tail_tests=80,
        comparisons='At eight prompts: FM minus baseline, each arm minus its own 660, and each arm minus its previous checkpoint. Five comparisons times eight checkpoints times two interval tails.',
        ...
        budget='1800 is an initial resource ceiling, not evidence of convergence. No automatic catalog promotion.',
...
def paired(a, b, records, *, count):
    ...
    result = paired_gain_bound(values[a], values[b], groups, planned_comparisons=80)
